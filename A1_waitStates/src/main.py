...
#                                                                              #
# 	Module:       main.py                                                      #
# 	Author:       Surya Gedipudi, Ritwik Singh                                 #
# 	Created:      5/2/2024, 2:02:23 PM                                         #
# 	Description:  Activity 1: Wait States                                      #
#                                                                              #
# ---------------------------------------------------------------------------- #
...
def main():
    ...
    motorVelocity = 70  # Velocity in % (max v = 200 rpm)
    brain.screen.set_cursor(1, 1)

    bump()      # Wait for the bump switch to be pressed
    
    spinMotors(motorVelocity)
    wait(5000, MSEC)    # Run motors for specified time, wait state
    stopMotors()
